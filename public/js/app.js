...
/* harmony import */ var _BirdShitForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BirdShitForm */ "./resources/js/components/BirdShitForm.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      form: new _BirdShitForm__WEBPACK_IMPORTED_MODULE_1__["default"]({
        title: '',
        description: '',
        tasks: [{
          body: ''
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.form.post('/projects').then(function (response) {
  ...
  return _c("div", { staticClass: "dropdown relative" }, [
    ...
    _c(
      "div",
      {
        ...
        staticClass:
          "dropdown-menu absolute bg-white py-2 rounded-lg mt-2 right-0",
          ...
          _c("div", { staticClass: "flex" }, [
            _c("div", { staticClass: "flex-1 mr-4" }, [
              _c("div", { staticClass: "mb-4" }, [
                _c(
                  "label",
                  {
                    staticClass: "mb-2 text-md block",
                    attrs: { for: "title" }
                  },
                  [_vm._v("Title")]
                ),
                ...
                _c("input", {
                  ...
                  staticClass:
                    "input bg-transparent border rounded p-2 text-xs block w-full",
              ...
              _c("div", { staticClass: "mb-4" }, [
                ...
                _c("textarea", {
                  ...
                  staticClass:
                    "textarea bg-transparent border rounded p-2 text-xs w-full",
            ...
            _c("div", { staticClass: "flex-1 ml-4" }, [
              _c(
                ...
                { staticClass: "mb-4" },
                [
                  _c("label", { staticClass: "mb-2 text-md block" }, [
                  ...
                  _vm._l(_vm.form.tasks, function(task) {
                    return _c("input", {
                      ...
                      staticClass:
                        "input bg-transparent border border-gray-500 rounded p-2 text-xs block w-full mb-2",
                      attrs: {
                        id: "task",
                        type: "text",
                        placeholder: "task 1"
              ...
              _c(
                "button",
                {
                  staticClass: "inline-flex items-center focus:outline-none",
                  attrs: { type: "button" },
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "mr-8" },
    _vm._l(_vm.themes, function(valueColor, keyThemeName) {
      return _c("button", {
        staticClass: "rounded-full p-3 border mr-2 focus:outline-none",
        class: { "border-blue-500": _vm.selectedTheme == keyThemeName },
        style: { backgroundColor: valueColor },
        on: {
          click: function($event) {
            _vm.selectedTheme = keyThemeName
          }
        }
      })
    }),
...
Vue.use(vue_js_modal__WEBPACK_IMPORTED_MODULE_0___default.a); // const files = require.context('./', true, /\.vue$/i)
...
/***/ "./resources/js/components/BirdShitForm.js":
/*!*************************************************!*\
  !*** ./resources/js/components/BirdShitForm.js ***!
  \*************************************************/
/*! exports provided: default */
...
var BirdShitForm = /*#__PURE__*/function () {
  function BirdShitForm(data) {
    _classCallCheck(this, BirdShitForm);
...
/* harmony default export */ __webpack_exports__["default"] = (BirdShitForm);
...
__webpack_require__(/*! C:\wamp64\www\birdshit\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\birdshit\resources\sass\app.scss */"./resources/sass/app.scss");
